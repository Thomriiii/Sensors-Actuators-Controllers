...
The final system represents a trade-off between measurement accuracy, control performance, and practical hardware limitations. This iterative process reflects real-world engineering practice, where theoretical designs must be adapted to account for implementation constraints.
...
GitHub Repository: \\
\textit{https://github.com/Thomriiii/Sensors-Actuators-Controllers/blob/main/Coursework1/closedloop-led/closedloop-led.ino}
